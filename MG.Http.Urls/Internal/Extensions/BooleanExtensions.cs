...
namespace MG.Http.Urls.Internal.Extensions
{
    ...
    internal static class BooleanExtensions
    {
        ...
        internal static int GetLength(this bool value)
        {
        ...
        ///     <see langword="false"/>.
        /// </returns>
        internal static bool TryFormat(this bool value, Span<char> destination, bool lowerCase, out int charsWritten)
        {
            if (lowerCase)
            {
                ReadOnlySpan<char> boolStr = value.ToString();
                Span<char> scratch = stackalloc char[destination.Length];
                charsWritten = boolStr.ToLower(scratch, null);
